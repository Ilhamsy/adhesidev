...
<?php if($this->session->userdata('level') == "admin"){ ?>
      ...
      <li><a href="<?= base_url('admin/jabatan') ?>"><i class="fa fa-circle-o"></i>Data Mentor</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Data Student</a></li>
          </ul>
        </li>
      ...
      <div class="row">
        <div class="box">
          <div class="box-header">
            <center><h3 class="box-title"><i class=""></i></h3></center></div>
            <div class="col-xs-12">
